...
public enum MessageConstant {
    ...
    EDIT_SETMEAL_SUCCESS("编辑套餐成功"),
    EDIT_SETMEAL_FAIL("编辑套餐失败"),
    DELETE_SETMEAL_SUCCESS("删除套餐成功"),
    DELETE_SETMEAL_FAIL("删除套餐失败"),
    ...
    public static MessageConstant instance(String message) {
        MessageConstant messageConstant = null;
        MessageConstant[] messageConstants = MessageConstant.values();
        for (MessageConstant messageConstant1:messageConstants) {
            if (Objects.equals(messageConstant1.getMessage(),message)) {
                messageConstant = messageConstant1;
            }
        }
